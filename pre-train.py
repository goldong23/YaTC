...
def get_args_parser():
    ...
    parser.add_argument('--label_level', default=1, type=int,
                        help='1-based directory depth under train/ to use as the class label')
...
def main(args):
    ...
    dataset_train = RecursiveImageDataset(train_root, transform=transform_train, label_level=args.label_level)
    print(f"Loaded {len(dataset_train)} training images from {train_root} across {len(dataset_train.classes)} classes (label_level={args.label_level})")
